...
<!--     <link rel="stylesheet" href="{{asset('assets/leaflet/leaflet-search-master/src/leaflet-search.css')}}"/>
<link rel="stylesheet" href="{{asset('assets/leaflet/leaflet.defaultextent-master/dist/leaflet.defaultextent.css')}}" />
<script src="{{asset ('assets/leaflet/leaflet-ajax/dist/leaflet.ajax.js')}}"></script>
<script src="{{asset ('assets/leaflet/leaflet-search-master/src/leaflet-search.js')}}"></script>
<script src="{{asset ('assets/leaflet/leaflet.defaultextent-master/dist/leaflet.defaultextent.js')}}"></script> -->
    ...
    <div class="outer">
        <div class="inner bg-container">
            @if(count($errors) > 0)
                ...
                @endif
              <form method="POST" action="/lokasi/adds" enctype="multipart/form-data" name="peta">
                    {{csrf_field()}}
                    <input type="hidden" name="id_company" value="{{auth()->user()->id_company}}">
                    <input type="hidden" name="company" value="{{auth()->user()->name}}">
                    <input type="hidden" name="lokasi" value="0" id="lokasi">
                    <div class="form-group">
                        <label for="email" class="col-form-label"> Nama Lokasi </label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="nama" placeholder="Title" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="longitude" placeholder="Post By"  >
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="email" class="col-form-label"> Latitude</label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="latitude" placeholder="Post By"  >
                        </div>
                    </div>
                     <div class="form-group">
