    ...
    <div class="outer">
        <table id="example1" class="display table table-stripped table-bordered">
            ...
            @foreach($company as $company)
                <tr>
                    <td><img width="100px" src="{{ url('/assets/uploads/logo/'.$company -> photo) }}"></td>
                    <td>{{$company -> nama}}</td>
                    <td width="200px">{{$company -> pemegangsaham}}</td>
                    <td>{{$company -> jperizinan}}</td>
                    <td>{{$company -> tkontrak}}</td>
                    <td width="200px">{{$company -> alamat}}</td>
                    <td>
                        <a href="/company/{{$company->id}}/detail" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        <a href="/company/{{$company->id}}/edit" class="btn btn-success"><i class="fa fa-edit"></i></a>
                        <a href="/company/{{$company->id}}/delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
