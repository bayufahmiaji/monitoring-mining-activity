              ...
              <form method="POST" action="/perusahaan/adds" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="nama" placeholder="Nama Perusahaan" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="pemegangsaham" placeholder="Pemegang sahams"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label"> Jenis Perizinan</label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="jperizinan" placeholder="Jenis Perizininan"  >
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="email" class="col-form-label"> Tanggal Kontrak</label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="tkontrak" placeholder="Tanggal Kontrak"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label">Alamat</label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="alamat" placeholder="alamat"  >
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="email" class="col-form-label">Bahan Galian</label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="galian" placeholder="Bahan Galian"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label">Email</label>
                        <div class="input-group input-group-prepend">
                            <input type="email" class="form-control  form-control-md" required name="email" placeholder="Email"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label">Password</label>
                        <div class="input-group input-group-prepend">
                            <input type="password" class="form-control  form-control-md" required name="password" placeholder="Password"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label">Logo Perusahaan</label>
                        <div class="input-group input-group-prepend">
