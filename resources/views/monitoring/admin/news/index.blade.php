...
<header class="head">
    ...
    <div class="outer">
        <a href="/berita/add" class="btn btn-primary">
        ...
        <table id="example1" class="display table table-stripped table-bordered">
            ...
            @foreach($news as $news)
                <tr>
                    <td>{{$news -> id}}</td>
                    <td>{{$news -> post_by}}</td>
                    <td><img width="100px" height="100px" src="{{asset('assets/uploads/news/'.$news->image)}}"></td>
                    <td>{{$news -> created_at}}</td>
                    <td><?=substr($news->description,0,100);?>...</td>
                    <td><a href="/user/{{$news->id}}/edit" class="btn btn-primary">Update</a>
                        <a href="/user/{{$news->id}}/delete" class="btn btn-danger">Delete</a></td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>
