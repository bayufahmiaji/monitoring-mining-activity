...
<header class="head">
        ...
        <div class="inner bg-container">
            @if(count($errors) > 0)
                ...
                @endif
              <form method="POST" action="/postuser" enctype="multipart/form-data">
                    {{csrf_field()}}

                    <div class="form-group">
                        <label for="email" class="col-form-label">Nama </label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="name" placeholder="Nama" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="email" placeholder="Email"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label">Password </label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="password" placeholder="Password" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="email" class="col-form-label">Perusahaan </label>
                        <div class="input-group input-group-prepend">
                           <select class="form-control" name="company" id="exampleFormControlSelect1">
                              <option value="Puslitbang TekMIRA" >Puslitbang TekMIRA</option>
